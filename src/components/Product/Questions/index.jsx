  ...
  return (
    <div className={styles.questions}>
      ...
      <div className={styles.container}>
        <h3 className={styles.lastquestions}>Últimas realizadas</h3>
        <div className={styles.containerquestions}>
          <span>
            <p className={styles.userquestion}>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Suscipit
              voluptates sed in perspiciatis placeat quo laborum, culpa,
              adipisci eius eaque magnam, sunt ullam veniam incidunt quae illo
              iste iure natus?
            </p>
            <p className={styles.answer}>
              ...
              quidem explicabo quos sunt ipsam culpa aliquam repudiandae
              tempore? Dolorum, eius minima? Consectetur error, similique
              eveniet sed adipisci, cumque at quibusdam provident officia soluta
              aut? Non optio deserunt numquam eius sequi voluptas reprehenderit
              quo ab possimus atque repudiandae illo ipsum, quia, necessitatibus
